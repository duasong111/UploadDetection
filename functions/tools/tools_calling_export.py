...
统一管理所有可用的工具
"""
from .test_tools import get_tools as weather_get_tools, get_tool_map as weather_get_tool_map
from .devices_info_tools import get_tools as device_get_tools, get_tool_map as device_get_tool_map

# 合并所有工具 Schema
AVAILABLE_TOOLS = []
AVAILABLE_TOOLS.extend(weather_get_tools())
AVAILABLE_TOOLS.extend(device_get_tools())

# 合并所有工具映射
TOOL_MAP = {}
TOOL_MAP.update(weather_get_tool_map())
